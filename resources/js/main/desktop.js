		...
		if(type == "about"){
			$("#" + uuid + " > #body > .content").append("<h1>김민진에 대한 기본 정보 보기</h1>" +
																		  "<div>" +
																		  	  ...
																		  	  "<p>Java · Spring 기반의 웹 애플리케이션 개발을 중심으로 역량을 쌓아왔으며,</p>" +
																		  	  "<p>하나를 배우더라도 원리를 이해하고 제대로 익히는 것을 중요하게 생각합니다.</p>" +
																		  	  "<p>탄탄한 기초를 바탕으로 변화에 빠르게 적응할 수 있는 개발자로 성장하고자 합니다.</p>" +
																		  "</div>" +
																		  "<ul>" +
																		  	  "<li class='profile'>" +
																		  	  	  ...
																		  	  	  "<div>" +
																						  ...
																						  "<p>그 외에도 이해가 잘 안 갔던 내용과 개인적으로 궁금했던 부분,</p>" +
																		  	  	  	  	  "<p>그리고 개발 과정에서 겪었던 문제와 그 해결 방법 등을 기록 중입니다.</p>" +
																		  	  	  	  "</div>" +
																		  	  	  "</div>" +
